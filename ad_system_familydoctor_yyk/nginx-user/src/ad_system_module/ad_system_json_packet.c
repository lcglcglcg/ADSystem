...
json_object *ad_system_json_packet_data_parse(json_object *json_root, ad_system_packet_json_data_t *json)
{
    ...
    GET_JSON_VALUE_STR(IMG_PATH,    "IMG_PATH");

    GET_JSON_VALUE_STR(CREATIVE_APPEND_NAME,	"CREATIVE_APPEND_NAME");
    GET_JSON_VALUE_STR(TEL,                         "TEL");
    GET_JSON_VALUE_STR(MAP_URL,                     "MAP_URL");
    GET_JSON_VALUE_STR(TIME_URL,                    "TIME_URL");
    GET_JSON_VALUE_STR(COMMENT_URL,                 "COMMENT_URL");
    GET_JSON_VALUE_STR(ADVISORY_URL,                "ADVISORY_URL");
    GET_JSON_VALUE_STR(MOBILE_URL,                  "MOBILE_URL");
    GET_JSON_VALUE_STR(DOCTORS_NAME,                "DOCTORS_NAME");
    GET_JSON_VALUE_STR(DOCTORS_DESCRIPTION,         "DOCTORS_DESCRIPTION");
    GET_JSON_VALUE_STR(DOCTORS_IMG,                 "DOCTORS_IMG");
    GET_JSON_VALUE_STR(HOSPITAL_IMG,                "HOSPITAL_IMG");
    
    GET_JSON_VALUE_STR(HOSPITAL_LEVLE, "HOSPITAL_LEVLE");
