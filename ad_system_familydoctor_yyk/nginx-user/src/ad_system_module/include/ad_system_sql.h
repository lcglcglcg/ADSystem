...
extern "C" { 
    ...
    extern int ad_system_sql_get_disease_code2(ad_system_sql_t *p);

    //推广->获取地域CODE
    extern int ad_system_sql_get_region_code(ad_system_sql_t *p);
    ...
    extern int ad_system_sql_get_creative_text_count(char *count,
	    const char *account_id, 
	    int find_type,
	    const char *campaign_id, 
	    const char *group_id, 
    ...
    //推广->修改文字创意
    extern int ad_system_sql_set_creative_text_status(char *CREATIVE_ID, int status);
    ...
    extern int ad_system_sql_get_group_count(char *count,
	    const char *account_id, 
	    int display_status, 
	    int find_type,
	    const char *campaign_id, 
