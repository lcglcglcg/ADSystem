#define NGX_CONFIGURE " --with-debug --add-module=src/ad_system_module --error-log-path=/ad_system/ad_system_39.net/log/nginx-user/wangmeng.log"
...
#define NGX_CONF_PATH  "/ad_system/ad_system_39.net/conf/ad_system_user.conf"
#endif


#ifndef NGX_PID_PATH
#define NGX_PID_PATH  "/ad_system/ad_system_39.net/conf/ad_system_user.pid"
#endif
...
#define NGX_ERROR_LOG_PATH  "/ad_system/ad_system_39.net/log/nginx-user/wangmeng.log"
#endif
