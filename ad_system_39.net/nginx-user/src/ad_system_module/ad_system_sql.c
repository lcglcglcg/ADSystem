	...
	const char *campign_name)
{
    ...
    fprintf(stdout, "ad_system_sql_set_campaign\n");
	...
	int type)
{
    ...
    if (mobile_destination_url && *mobile_destination_url)
	sprintf(mobile_destination_url_str, "'%s'", mobile_destination_url);

    char mobile_display_url_str[1024] = "null";
    if (mobile_display_url && *mobile_display_url)
	sprintf(mobile_display_url_str, "'%s'", mobile_display_url);
    ...
    fprintf(stderr, "mobile_destination_url_str=%s\n", mobile_destination_url_str);
    fprintf(stderr, "mobile_display_url_str=%s\n", mobile_display_url_str);
    fprintf(stderr, "-->%s\n", sql_str);
	...
	int type)
{
    ...
    char region_serialize_sql[409600] = "null";
    if (region_type == 1)
	region_type = 0;
    else {
