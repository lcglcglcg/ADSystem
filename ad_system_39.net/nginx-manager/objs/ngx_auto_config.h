#define NGX_CONFIGURE " --add-module=src/ad_system_manager_module --with-debug --error-log-path=/ad_system/ad_system_39.net/log/nginx-manager/wangmeng.log"
...
#define NGX_CONF_PATH  "/ad_system/ad_system_39.net/conf/ad_system_manager.conf"
#endif


#ifndef NGX_PID_PATH
#define NGX_PID_PATH  "/ad_system/ad_system_39.net/conf/ad_system_manager.pid"
#endif
...
#define NGX_ERROR_LOG_PATH  "/ad_system/ad_system_39.net/log/nginx-manager/wangmeng.log"
#endif
