...
int  ad_system_packet_get_creative_text(ngx_http_request_t *r, ad_system_packet_json_data_t *json)
{
	...
	max += size = lg_string_json_sprintf(buffer, comma, "}", 20,
		"%s",	"ACCOUNT_ID",		ad_system_sql_get_string(&sql_conn, NULL, 1),
		"%s",	"CAMPAIGN_ID",		ad_system_sql_get_string(&sql_conn, NULL, 2),
		"%s",	"ADGROUP_ID",		ad_system_sql_get_string(&sql_conn, NULL, 3),
		"%s",	"CREATIVE_ID",		ad_system_sql_get_string(&sql_conn, NULL, 4),
		"%s",	"TITLE",		ad_system_sql_get_string(&sql_conn, NULL, 5),
		"%s",	"DESCRIPTION",		ad_system_sql_get_string(&sql_conn, NULL, 6),
		"%s",	"DISPLAY_URL",		ad_system_sql_get_string(&sql_conn, NULL, 7),
		"%s",	"WEB_IM",		ad_system_sql_get_string(&sql_conn, NULL, 8),
		"%s",	"IMG0_URL",		ad_system_sql_get_string(&sql_conn, NULL, 9),
		"%s",	"IMG1_URL",		ad_system_sql_get_string(&sql_conn, NULL, 10),
		"%s",	"IMG2_URL",		ad_system_sql_get_string(&sql_conn, NULL, 11),
		"%s",	"IMG3_URL",		ad_system_sql_get_string(&sql_conn, NULL, 12),
		"%s",	"IMG4_URL",		ad_system_sql_get_string(&sql_conn, NULL, 13),
		"%s",	"IMG5_URL",		ad_system_sql_get_string(&sql_conn, NULL, 14),
		"%s",	"CREATE_TIME",		ad_system_sql_get_string(&sql_conn, NULL, 15),
		"%s",	"LAST_UPDATE_TIME",	ad_system_sql_get_string(&sql_conn, NULL, 16),
		"%s",	"DESTINATION_URL",	ad_system_sql_get_string(&sql_conn, NULL, 17),
		"%s",	"CAMPAIGN_NAME",	ad_system_sql_get_string(&sql_conn, NULL, 18),
		"%s",	"GROUP_NAME",		ad_system_sql_get_string(&sql_conn, NULL, 19),
		"%s",	"TEL",			ad_system_sql_get_string(&sql_conn, NULL, 20)
		);
...
int ad_system_packet_parse(ngx_http_request_t *r)
{
	...
	} else if (strcmp(packet_type, "GET_DISEASE_CODE2") == 0) {		//疾病
	    ad_system_packet_get_disease_code2(r, &json_data);
