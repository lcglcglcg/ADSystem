#define NGX_CONFIGURE " --with-debug --add-module=src/ad_system_module --error-log-path=/ad_system/ad_system_familydoctor_ask/log/nginx-user/wangmeng.log"
...
#define NGX_CONF_PATH  "/ad_system/ad_system_familydoctor_ask/conf/ad_system_user.conf"
#endif
...
#define NGX_ERROR_LOG_PATH  "/ad_system/ad_system_familydoctor_ask/log/nginx-user/wangmeng.log"
#endif
