#define NGX_CONFIGURE " --add-module=src/ad_system_manager_module --with-debug --error-log-path=/ad_system/ad_system_familydoctor_ask/log/nginx-manager/wangmeng.log"
...
#define NGX_CONF_PATH  "/ad_system/ad_system_familydoctor_ask/conf/ad_system_manager.conf"
#endif
...
#define NGX_ERROR_LOG_PATH  "/ad_system/ad_system_familydoctor_ask/log/nginx-manager/wangmeng.log"
#endif
