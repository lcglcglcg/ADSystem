...
json_object *ad_system_json_packet_data_parse(json_object *json_root, ad_system_packet_json_data_t *json)
{
    ...
    GET_JSON_VALUE_NUM(FIND_NAME_COL, "FIND_NAME_COL");
    GET_JSON_VALUE_NUM(BALANCE_TYPE, "BALANCE_TYPE");

    GET_JSON_VALUE_NUM(CREATIVE_TYPE, "CREATIVE_TYPE");
    GET_JSON_VALUE_STR(CREATIVE_REFUSE_REASON, "CREATIVE_REFUSE_REASON");
    GET_JSON_VALUE_STR(CREATIVE_ID_ARRAY, "CREATIVE_ID_ARRAY");

    GET_JSON_VALUE_STR(MEDIA_ID, "MEDIA_ID");
    GET_JSON_VALUE_NUM(MEDIA_TYPE, "MEDIA_TYPE");

    GET_JSON_VALUE_STR(GUAHAO_TOKEN, "GUAHAO_TOKEN");
    GET_JSON_VALUE_STR(HOSPITAL_IMG, "HOSPITAL_IMG");
    GET_JSON_VALUE_STR(LOGIN_PASSWORD, "LOGIN_PASSWORD");
    GET_JSON_VALUE_STR(REGION_NAME_CN, "REGION_NAME_CN");

    GET_JSON_VALUE_NUM(INSERT_TYPE, "INSERT_TYPE");
    GET_JSON_VALUE_STR(LOGIN_NAME, "LOGIN_NAME");
    GET_JSON_VALUE_STR(API_TOKEN, "API_TOKEN");
    GET_JSON_VALUE_NUM(ACCOUNT_ID_TYPE, "ACCOUNT_ID_TYPE");
    GET_JSON_VALUE_STR(ACCOUNT_ID, "ACCOUNT_ID");

    GET_JSON_VALUE_STR(ANNOUNCEMENT_ID, "ANNOUNCEMENT_ID");
    GET_JSON_VALUE_STR(ANNOUNCEMENT_TITLE, "ANNOUNCEMENT_TITLE");
    GET_JSON_VALUE_STR(SEND_TIME, "SEND_TIME");
    GET_JSON_VALUE_STR(CONTENT, "CONTENT");

    GET_JSON_VALUE_STR(MONEY, "MONEY");
    GET_JSON_VALUE_NUM(PAYMENT_TYPE, "PAYMENT_TYPE");
    GET_JSON_VALUE_STR(ACCOUNTING_DOCUMENT_NUMBER, "ACCOUNTING_DOCUMENT_NUMBER");
    GET_JSON_VALUE_STR(ACCOUNTING_DOCUMENT_FILE, "ACCOUNTING_DOCUMENT_FILE");
    GET_JSON_VALUE_STR(ACCOUNTING_DOCUMENT_REMARK, "ACCOUNTING_DOCUMENT_REMARK");

    GET_JSON_VALUE_STR(SALES, "SALES");			//销售
    GET_JSON_VALUE_STR(CUSTOMER_SERVICE, "CUSTOMER_SERVICE");	//客服部

    GET_JSON_VALUE_NUM(PLACE_REGION, "PLACE_REGION");
    GET_JSON_VALUE_NUM(DSP_STATUS, "DSP_STATUS");
    ...
    GET_JSON_VALUE_STR(CREATE_TIME_START, "CREATE_TIME_START");
    GET_JSON_VALUE_STR(CREATE_TIME_END, "CREATE_TIME_END");

    GET_JSON_VALUE_NUM(BRAND_TYPE, "BRAND_TYPE");
    GET_JSON_VALUE_STR(BRAND_ID, "BRAND_ID");
    GET_JSON_VALUE_NUM(BRAND_ID_TYPE, "BRAND_ID_TYPE");

    GET_JSON_VALUE_NUM(PAGE_TYPE, "PAGE_TYPE");

    GET_JSON_VALUE_STR(PRICE, "PRICE");
    GET_JSON_VALUE_STR(REFUSE_REASON, "REFUSE_REASON");

    GET_JSON_VALUE_NUM(SHOW_TIME_TYPE, "SHOW_TIME_TYPE");
    GET_JSON_VALUE_NUM(CREATE_TIME_TYPE, "CREATE_TIME_TYPE");

    GET_JSON_VALUE_NUM(DISCOUNT, "DISCOUNT");

    GET_JSON_VALUE_STR(CPC_PRICE, "CPC_PRICE");
    GET_JSON_VALUE_STR(BUDGET_MORE, "BUDGET_MORE");
    GET_JSON_VALUE_STR(BUDGET_LESS, "BUDGET_LESS");
    
    GET_JSON_VALUE_STR(ACCOUNT_NAME, "ACCOUNT_NAME");
    
    GET_JSON_VALUE_STR(UPLOAD_ID, "UPLOAD_ID");
    GET_JSON_VALUE_STR(IMG_ID, "IMG_ID");
    
    GET_JSON_VALUE_NUM(JOIN_DSP, "JOIN_DSP");
    
    GET_JSON_VALUE_STR(DOCTORS_ID, "DOCTORS_ID");
    return json_root;
}
